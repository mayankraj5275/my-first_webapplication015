  ...
  <body class="">
    <div class="wrapper">
      ...
      <div class="message">
        ...
        <div class="text">
          <h1>Congratulations MAYANK !</h1>
          <h2>I just created a Java Spring web application.</h2>
        </div>
      </div>
    </div>

    <footer>
      <p class="footer-contents">Designed and developed By YOGYA in MAHESHKHUNT.</p>
    </footer>
